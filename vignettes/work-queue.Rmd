...
How do you decide which server works on what?
What if one server dies mid-way?
...
In this example, our work will be generating square roots.
We'll keep track of the results in a table:
...
Finally, we should wait for any incoming messages.
To do this, use ``postgresWaitForNotify``.
...
Using SKIP LOCKED is discussed in more detail [in this article](https://www.cybertec-postgresql.com/en/skip-locked-one-of-my-favorite-9-5-features/).
