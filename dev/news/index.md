...
- Record the v1.4.8 tag on the mainline
  ([\#604](https://github.com/r-dbi/RPostgres/issues/604)).
...
- Drop the ARM64 Windows entry, which has no PostgreSQL server
  ([\#601](https://github.com/r-dbi/RPostgres/issues/601)).
...
## RPostgres 1.4.10.9014 (2026-08-08)
...
## RPostgres 1.4.10.9013 (2026-08-06)
...
- Ci: Harden `workflow_run` workflows against untrusted pull requests
  ([\#106](https://github.com/r-dbi/RPostgres/issues/106)).

- Ci: Pin third-party actions to commits and let Renovate keep them
  pinned ([\#105](https://github.com/r-dbi/RPostgres/issues/105)).
...
- Install `tzdata-legacy` on Ubuntu 26.04
  ([\#593](https://github.com/r-dbi/RPostgres/issues/593)).
...
- Ci: Apply matrix `env` vars in the workflow, not in custom actions
  ([\#95](https://github.com/r-dbi/RPostgres/issues/95)).

- Ci: Link the responsible workflow run in snapshot update PRs
  ([\#96](https://github.com/r-dbi/RPostgres/issues/96)).

- Ci: Harden `format-suggest` against `pull_request_target` pwn requests
  ([\#93](https://github.com/r-dbi/RPostgres/issues/93)).
